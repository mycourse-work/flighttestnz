# Calibration Workshop — The Difficult Debrief

This workshop places the examiner in a situation where the assessment decision is only part of the challenge. Identify decisive evidence, distinguish isolated error from pattern, formulate the outcome, communicate it professionally, respond to challenge and ensure the written record supports the reasoning.
...
On the first occasion there is no response to the call; the candidate checks the radio, identifies the error and corrects it independently. Later in the assessment the same type of error occurs again. This time the candidate repeats the call and does not identify the incorrect selection until the examiner asks the neutral question, “Confirm the frequency you have selected.” The candidate then recognises the error, selects the correct frequency and continues.
...
<div class="reflection-answer"><strong>Model position:</strong> Professional authority is demonstrated by remaining calm, identifying the evidence, applying the standard, explaining the reasoning and recording the decision defensibly. It is not demonstrated by winning an argument.</div>
</div>

> **Calibration question:** Would another experienced examiner, presented with the same evidence and the same standard, understand and support the reasoning behind your decision?
