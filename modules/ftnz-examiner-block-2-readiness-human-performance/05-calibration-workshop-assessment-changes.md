# Calibration Workshop — The Assessment That Changes
...
The first part of the assessment is strong. The candidate demonstrates accurate aircraft handling, good procedural discipline, effective communication and sound planning. You begin forming a very positive impression.
...
During the diversion, workload settles. The candidate becomes proactive again. Communication improves. Planning becomes organised. The remainder of the assessment is satisfactory.

<div class="reflection" data-id="block-2-final-calibration-reasoning" data-min-chars="150">
<div class="reflection-prompt"><strong>Mandatory calibration reflection</strong><br>Record: (1) what evidence supports competence; (2) what raises concern; (3) whether you see isolated events or a meaningful pattern; (4) how important the recovery is; (5) what further evidence you would want if the standard allowed another valid opportunity; and (6) which competency or standard carries the greatest weight.</div>
<div class="reflection-answer"><strong>Model reasoning:</strong> There is deliberately no universal pass/fail result in this generic scenario. Recognise strong early technical and procedural evidence; avoid a halo effect; recognise the cluster of workload-related observations; distinguish individual errors from a possible pattern; evaluate the timing and quality of the weather decision; recognise later recovery as genuine evidence without allowing it to erase earlier concerns; and reach the outcome from the applicable standard.</div>
</div>

> **Calibration question:** Would another experienced examiner, presented with the same evidence and the same standard, understand why you reached that decision?
